...
public class OboAuthProvider extends BaseAuthenticationProvider{
    ...
    public boolean hasAdminRole() {
        String token = this.getAccessTokenFromRequest();
        ...
        if(!payload.contains("\"roles\":[\"PrivilegedAdmin\"]"))
            return false;
        return true;
    }
    ...
    public boolean hasUserRole() {
        ...
        if(!payload.contains("\"roles\":[\"PrivilegedAdmin\"]") & !payload.contains("\"roles\":[\"RegularUser\"]"))
            return false;
        return true;
    }
}
