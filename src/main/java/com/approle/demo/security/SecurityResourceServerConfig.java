package com.approle.demo.security;

import com.approle.demo.utils.AADClaimsVerifier;
...
public class SecurityResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    @Value("${security.oauth2.app.roles}")
    ...
    public JwtClaimsSetVerifier claimSetVerifier() {
        return new AADClaimsVerifier(aadAliases, acceptedTenants, applicationId, appRoles);
    }
}
